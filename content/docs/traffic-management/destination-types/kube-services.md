...
{{< callout type="info" >}}
Most guides in this documentation route traffic to a Kubernetes service directly. If you want to configure additional settings for your Kubernetes service, such as the HTTP/2 protocol or a different load balancing algorithm, use an Upstream resource as your backing destination instead. For more information, see [Upstreams](/traffic-management/destination-types/upstreams/). 
{{< /callout >}}

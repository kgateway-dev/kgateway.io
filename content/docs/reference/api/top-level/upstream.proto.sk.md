...
| `loadBalancerConfig` | [.gloo.solo.io.LoadBalancerConfig](../../components/load_balancer.proto.sk/#loadbalancerconfig) | Settings for the load balancer that sends requests to the Upstream. The load balancing method is set to round robin by default. |

...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `version` | [.solo.io.envoy.type.v3.SemanticVersion](../semantic_version.proto.sk/#semanticversion) | SemVer version of extension. |
...
| `version` | [.solo.io.envoy.config.core.v3.BuildVersion](#buildversion) | The version is a property of the extension and maintained independently of other extensions and the Envoy API. This field is not set when extension did not provide version information. |
...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `header` | [.solo.io.envoy.config.core.v3.HeaderValue](#headervalue) | Header name/value pair that this option applies to. |
...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `headers` | [[]solo.io.envoy.config.core.v3.HeaderValue](#headervalue) |  |
...
| `retryPolicy` | [.solo.io.envoy.config.core.v3.RetryPolicy](#retrypolicy) | Retry policy for fetching remote data. |
...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `local` | [.solo.io.envoy.config.core.v3.DataSource](#datasource) | Local async data source. Only one of `local` or `remote` can be set. |
| `remote` | [.solo.io.envoy.config.core.v3.RemoteDataSource](#remotedatasource) | Remote async data source. Only one of `remote` or `local` can be set. |
...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `defaultValue` | [.solo.io.envoy.type.v3.FractionalPercent](../percent.proto.sk/#fractionalpercent) | Default value if the runtime value's for the numerator/denominator keys are not available. |

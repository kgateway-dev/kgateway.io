...
| `transformerConfig` | [.solo.io.envoy.config.core.v3.TypedExtensionConfig](../extension.proto.sk/#typedextensionconfig) | transformer configuration used to process response data cannot be configured simultaneously with unwrap_as_alb. |
| `requestTransformerConfig` | [.solo.io.envoy.config.core.v3.TypedExtensionConfig](../extension.proto.sk/#typedextensionconfig) | This is a transformer config, as defined in api.envoy.config.filter.http.transformation.v2 used to process request data. |

...
| `zipkinConfig` | [.solo.io.envoy.config.trace.v3.ZipkinConfig](../zipkin.proto.sk/#zipkinconfig) |  Only one of `zipkinConfig`, `datadogConfig`, `openTelemetryConfig`, or `openCensusConfig` can be set. |
| `datadogConfig` | [.solo.io.envoy.config.trace.v3.DatadogConfig](../datadog.proto.sk/#datadogconfig) |  Only one of `datadogConfig`, `zipkinConfig`, `openTelemetryConfig`, or `openCensusConfig` can be set. |
| `openTelemetryConfig` | [.solo.io.envoy.config.trace.v3.OpenTelemetryConfig](../opentelemetry.proto.sk/#opentelemetryconfig) |  Only one of `openTelemetryConfig`, `zipkinConfig`, `datadogConfig`, or `openCensusConfig` can be set. |
| `openCensusConfig` | [.solo.io.envoy.config.trace.v3.OpenCensusConfig](../opencensus.proto.sk/#opencensusconfig) |  Only one of `openCensusConfig`, `zipkinConfig`, `datadogConfig`, or `openTelemetryConfig` can be set. |
